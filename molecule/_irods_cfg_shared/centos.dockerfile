...
RUN echo '[base]' > /etc/yum.repos.d/CentOS-Base.repo && \
	...
	echo 'baseurl=https://archive.kernel.org/centos-vault/7.9.2009/os/$basearch/' \
	...
	echo 'baseurl=https://archive.kernel.org/centos-vault/7.9.2009/updates/$basearch/' \
		>> /etc/yum.repos.d/CentOS-Base.repo && \
	echo 'gpgcheck=1' >> /etc/yum.repos.d/CentOS-Base.repo && \
	echo 'gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-CentOS-7' \
		>> /etc/yum.repos.d/CentOS-Base.repo && \
	...
	echo 'baseurl=https://archive.kernel.org/centos-vault/7.9.2009/extras/$basearch/' \
		>> /etc/yum.repos.d/CentOS-Base.repo && \
	echo 'gpgcheck=1' >> /etc/yum.repos.d/CentOS-Base.repo && \
	echo 'gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-CentOS-7' \
		>> /etc/yum.repos.d/CentOS-Base.repo
